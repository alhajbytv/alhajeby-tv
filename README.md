[tvindex.html](https://github.com/user-attachments/files/23886978/tvindex.html)
<!DOCTYPE html>
...
<meta name="description" content="شاهد البث المباشر لقنوات بي إن سبورت والعربية والرياضية - مباريات حية مجاناً - alhajiby tv ينقل لك أهم الأحداث الرياضية العربية والعالمية">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"/>
...
/* قسم بي إن سبورت الجديد - من الكود الأول */
.bein-section {
...
/* شبكة القنوات الجديدة - من الكود الأول */
.channels-grid {
    display: grid;
...
<div class="welcome-screen" id="welcomeScreen">
    <div class="welcome-content">
        ...
        <h1 class="welcome-title">alhajiby tv</h1>
...
<header class="app-header" style="display:none" id="mainHeader">
    <div class="brand">
        ...
        <div>
            <div class="title">alhajiby tv</div>
...
const beinSportsChannels = [
    {
        ...
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports1.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-1/'
    },
    {
        id: 'bein2', 
        name: 'بي إن سبورت HD 2',
        description: 'الدوري الإسباني والإيطالي',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports2.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-2/'
    },
    {
        id: 'bein3',
        name: 'بي إن سبورت HD 3', 
        description: 'الدوري الفرنسي والأوروبي',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports3.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-3/'
    },
    {
        id: 'bein4',
        name: 'بي إن سبورت HD 4',
        description: 'NBA وكرة السلة العالمية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports4.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-4/'
    },
    {
        id: 'bein5',
        name: 'بي إن سبورت HD 5',
        description: 'تنس وكرة اليد',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports5.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-5/'
    },
    {
        id: 'bein6',
        name: 'بي إن سبورت HD 6',
        description: 'رياضات متعددة وأحداث خاصة',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports6.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-6/'
    },
    {
        id: 'bein7',
        name: 'بي إن سبورت HD 7',
        description: 'أحداث رياضية حصرية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports7.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-7/'
    },
    {
        id: 'bein8',
        name: 'بي إن سبورت HD 8',
        description: 'البطولات العالمية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports8.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-8/'
    },
    {
        id: 'bein9',
        name: 'بي إن سبورت HD 9',
        description: 'الرياضات المختلفة',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports9.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-9/'
    },
    {
        id: 'bein10',
        name: 'بي إن سبورت HD 10',
        description: 'القناة الاحتياطية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinsports10.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-10/'
    },
    {
        id: 'beinnba',
        name: 'بي إن سبورت NBA',
        description: 'دوري كرة السلة الأمريكي',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinnba.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-nba/'
    },
    {
        id: 'beinpremium1',
        name: 'بي إن سبورت PREMIUM 1',
        description: 'القناة المميزة الأولى',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinpremium1.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-premium-1/'
    },
    {
        id: 'beinpremium2',
        name: 'بي إن سبورت PREMIUM 2',
        description: 'القناة المميزة الثانية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinpremium2.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-premium-2/'
    },
    {
        id: 'beinnews',
        name: 'بي إن سبورت NEWS',
        description: 'أخبار الرياضة على مدار الساعة',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinnews.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-news/'
    },
    {
        id: 'beinen1',
        name: 'بي إن سبورت English 1',
        description: 'القناة الإنجليزية الأولى',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinen1.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-en-1/'
    },
    {
        id: 'beinen2',
        name: 'بي إن سبورت English 2',
        description: 'القناة الإنجليزية الثانية',
        logo: 'https://i.ibb.co/0Q8L8wZ/beinen2.png',
        url: 'https://withered-mud-4e52.koora-live.workers.dev/?url=https://s3.stream-on.live/albaplayer/bein-en-2/'
    }
];
...
// شعارات احتياطية في حالة عدم تحميل الصور
const backupLogos = {
    'bein1': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/BeIN_Sports_1_logo.svg/240px-BeIN_Sports_1_logo.svg.png',
    'bein2': 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/BeIN_Sports_2_logo.svg/240px-BeIN_Sports_2_logo.svg.png',
    'bein3': 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/BeIN_Sports_3_logo.svg/240px-BeIN_Sports_3_logo.svg.png',
    'bein4': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/BeIN_Sports_4_logo.svg/240px-BeIN_Sports_4_logo.svg.png',
    'bein5': 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/BeIN_Sports_5_logo.svg/240px-BeIN_Sports_5_logo.svg.png',
    'bein6': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'bein7': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'bein8': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'bein9': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'bein10': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'beinnba': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'beinpremium1': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'beinpremium2': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'beinnews': 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/BeIN_Sports_News_logo.svg/240px-BeIN_Sports_News_logo.svg.png',
    'beinen1': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png',
    'beinen2': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/BeIN_Sports_6_logo.svg/240px-BeIN_Sports_6_logo.svg.png'
};

// دوال المشغل الجديد - من الكود الأول
function playChannel(channelId) {
    ...
    currentChannelLogo.onerror = function() {
        this.src = backupLogos[channel.id];
    };
...
// تحميل قنوات بي إن سبورت الجديدة مع التصميم الجديد
function loadBeinSports() {
    ...
    beinSportsChannels.forEach(channel => {
        ...
        html += '<img class="channel-logo-img" src="' + channel.logo + '" alt="' + channel.name + '" onerror="this.src=\'' + backupLogos[channel.id] + '\'">';
